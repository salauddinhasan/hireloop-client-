...
const LoginPage = () => {
  ...
  return (
    <section className="w-full  bg-[#070708] text-white flex items-center justify-center py-16 px-4 relative">
      ...
      {/* Main Login Card */}
      <div className="w-full max-w-sm bg-[#0d0e11]/60 border border-white/[0.06] rounded-2xl p-6 backdrop-blur-xl shadow-[0_0_50px_rgba(0,0,0,0.5)]">
        {/* Header */}
        <div className="mb-6">
          ...
          <div className="space-y-1.5">
            <div className="flex items-center justify-between">
              ...
              <Link
                ...
                className="text-[11px] text-[#4d46ff] hover:underline"
              >
                Forgot password?
              </Link>
            </div>
